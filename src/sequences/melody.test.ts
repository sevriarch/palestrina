...
describe('Melody.augmentRhythm()', () => {
    ...
    test('reduces durations, offsets and delays', () => {
        expect(s.augmentRhythm(0.5)).toStrictEqual(melody([
            ...
            { pitch: [ 61, 64 ], duration: 25, velocity: 50, at: 100 },
            { pitch: [ 66 ], duration: 25, velocity: 60, delay: 25 },
            { pitch: [ 69 ], duration: 75, velocity: 50, at: 40 },
            { pitch: [ 72 ], duration: 50, velocity: 60, after: [ { event: 'sustain', value: 0, at: 600 } ] },
        ]));
    });
    ...
    test('increases durations, offsets and delays', () => {
        expect(s.augmentRhythm(5)).toStrictEqual(melody([
            ...
            { pitch: [ 61, 64 ], duration: 250, velocity: 50, at: 100 },
            { pitch: [ 66 ], duration: 250, velocity: 60, delay: 250 },
            { pitch: [ 69 ], duration: 750, velocity: 50, at: 40 },
            { pitch: [ 72 ], duration: 500, velocity: 60, after: [ { event: 'sustain', value: 0, at: 600 } ] },
        ]));
    });
});
