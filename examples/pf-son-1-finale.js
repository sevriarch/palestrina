...
function makeVolume() {
    ...
    return numseq(imports.constant(LEN, MF))
        .modifySlice(bar(3), bar(6), dy(MF, F))
        .modifySlice(bar(6), bar(8), dy(F))
        .modifySlice(bar(8), bar(10), dy(F, MF))
        .modifySlice(bar(12), bar(14), dy(MF, F))
        .modifySlice(bar(14), bar(16), dy(F))
        .modifySlice(bar(16), bar(18), dy(F, MF))
        .modifySlice(bar(20), bar(22), dy(MF, F))
        .modifySlice(bar(22), bar(24), dy(F))
        .modifySlice(bar(24), bar(26), dy(F, MF))
        .modifySlice(bar(27), bar(29), dy(MF, P))
        .modifySlice(bar(33), bar(36), dy(MF, MP))
        .modifySlice(bar(36), bar(37), dy(MP))
        .modifySlice(bar(37), bar(42), dy(P, PP))
        .modifySlice(bar(42), bar(46), dy(PP))
        .modifySlice(bar(46), bar(48), dy(P, MP))
        .modifySlice(bar(48), bar(49), dy(MP))
        .modifySlice(bar(49), bar(53), dy(MP, P))
        .modifySlice(bar(53), bar(56), dy(PP))
        .modifySlice(bar(56), bar(59), dy(PP, P))
        .modifySlice(bar(59), bar(61), dy(P, PP))
        .modifySlice(bar(61), bar(69), dy(MP))
        .modifySlice(bar(69), bar(71), dy(PP))
        .modifySlice(bar(71), bar(75), dy(PP, MF))
        .modifySlice(bar(77), bar(80), dy(P, F))
        .modifySlice(bar(80), -1, dy(F, PP))
        .append(numseq([ PP, PP ]))
}
